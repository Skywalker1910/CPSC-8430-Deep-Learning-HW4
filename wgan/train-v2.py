...
# Hyperparameters
nz = 100
epochs = 50  # Increased to match notebook observations
batch_size = 64  # Aligned with the notebooks for better stability
lr = 1.5e-4  # Adjusted learning rate
critic_iterations = 5  # Number of critic iterations per generator iteration
...
for epoch in range(epochs):
    for i, data in enumerate(dataloader, 0):
        # Train Discriminator multiple times (critic iterations)
